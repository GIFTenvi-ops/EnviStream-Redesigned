    ...
    <div className={`relative h-full w-full bg-slate-900/60 backdrop-blur ${className}`}>
      ...
      <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
        <button
          ...
          className="w-11 h-11 grid place-items-center rounded-full bg-fuchsia-500/90 hover:bg-fuchsia-500 backdrop-blur border border-white/25 text-white shadow-lg transition hover:scale-105"
        >
