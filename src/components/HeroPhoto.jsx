...
export default function HeroPhoto() {
  ...
  return (
    <div className="relative h-full min-h-[480px] lg:min-h-[620px] rounded-[22px] overflow-hidden border border-white/40 bg-slate-900/50 backdrop-blur-xl shadow-[0_32px_80px_-28px_rgba(249,115,22,.4)]">
      {!missing ? (
        <img
          src="/hero-photo.jpg"
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#092f39]/80 via-[#0d171d]/70 to-[#51686f]/70 backdrop-blur-xl">
          <div className="absolute inset-0 hero-grid opacity-40" aria-hidden />
          <div className="absolute -top-20 -right-20 w-72 h-72 rounded-full bg-[#d4a85d]/20 blur-[100px]" aria-hidden />
          <div className="absolute -bottom-24 -left-16 w-72 h-72 rounded-full bg-[#8ec5cf]/15 blur-[100px]" aria-hidden />
          <div className="relative h-full grid place-items-center px-8 text-center">
            <div>
              <svg viewBox="0 0 48 48" className="w-16 h-16 mx-auto" fill="none" aria-hidden>
                <path d="M6 10 C13 16 18 25 20 38 C22 25 27 16 42 9 C31 14 26 17 24 19 C22 17 14 13 6 10Z" fill="#D946EF" />
                <path d="M26 14 C32 18 33 28 32 40 C34 30 34 20 39 12 C35 12 29 12 26 14Z" fill="#22D3EE" />
              </svg>
              <p className="font-display font-extrabold text-white text-2xl mt-4">
                Envistream <span className="text-[#d4a85d]">EduSkill</span>
              </p>
      ...
      <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between gap-3 rounded-2xl bg-white/15 backdrop-blur-2xl border border-white/25 px-5 py-4">
        ...
        <Link
          to="/courses"
          className="shrink-0 inline-flex items-center gap-1.5 rounded-xl bg-[#d4a85d] hover:bg-[#e2bb72] backdrop-blur border border-[#f0deaf]/60 text-[#0d171d] text-[13px] font-bold px-4 py-2.5 transition"
        >
